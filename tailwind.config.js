...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Semantic surface + text tokens, driven by CSS variables so that
        // light/dark are a single source of truth in index.css.
        ...
        // Brand: the logo's blue -> orange gradient.
        brand: {
          50: '#eef4ff',
          100: '#d9e6ff',
          200: '#bcd3ff',
      ...
      boxShadow: {
        ...
        'card-hover': '0 4px 8px -2px rgb(16 24 40 / 0.08), 0 2px 4px -2px rgb(16 24 40 / 0.04)',
